...
```console
sudo pacman -S xdg-user-dirs --needed
```
Then  run 
```console
...
#### Install
```console
sudo pacman -S docker-compose --needed
```
...
# yay -S ttf-cica
git clone https://github.com/miiton/Cica.git --depth 1
cd Cica
