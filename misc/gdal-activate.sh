...
# locate this file in $CONDA_PREFIX/etc/conda/activate.d
...
if [ -d "$CONDA_PREFIX/lib/python3.8/site-packages/fiona/gdal_data" ]; then
    export GDAL_DATA="$CONDA_PREFIX/lib/python3.8/site-packages/fiona/gdal_data"
elif [ -d "$CONDA_PREFIX/lib/python3.9/site-packages/fiona/gdal_data" ]; then
    export GDAL_DATA="$CONDA_PREFIX/lib/python3.9/site-packages/fiona/gdal_data"
elif [ -d "$CONDA_PREFIX/lib/python3.10/site-packages/fiona/gdal_data" ]; then
    export GDAL_DATA="$CONDA_PREFIX/lib/python3.10/site-packages/fiona/gdal_data"
elif [ -d "$CONDA_PREFIX/lib/python3.11/site-packages/fiona/gdal_data" ]; then
    export GDAL_DATA="$CONDA_PREFIX/lib/python3.11/site-packages/fiona/gdal_data"
fi
